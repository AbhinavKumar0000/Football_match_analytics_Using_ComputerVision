...
import numpy as np
sys.path.append('../')
from ulits import get_center_of_bbox, get_bbox_width,get_foot_position
...
class Tracker:
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        ...
        # Get team ball control up to the current frame
        ...
        cv2.putText(frame, f"Team A Possession: {team_1_percentage:.2f}%", (1400, 900), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (0, 0, 0), 3)
        cv2.putText(frame, f"Team B Possesion: {team_2_percentage:.2f}%", (1400, 950), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (0, 0, 0), 3)
